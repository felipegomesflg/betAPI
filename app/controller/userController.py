...
def create_user_fav_bet(user: schemas.UserFav, db: Session = Depends(get_db)):
...
def delete_user_fav_bet(userId:int,betId:int, db: Session = Depends(get_db)):
...
def create_user_fav_user(user: schemas.UserFav, db: Session = Depends(get_db)):
...
def delete_user_fav_user(userId:int,userFavId:int, db: Session = Depends(get_db)):
...
def create_user_fav_cod(user: schemas.UserFav, db: Session = Depends(get_db)):
...
def delete_user_fav_bet(userId:int, cod:str, db: Session = Depends(get_db)):
